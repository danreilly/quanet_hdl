...
# The adc_xfer_req_m signals are in axi_adcxfifo_wr.v and maybe elsewhere too.
# Note the -hier means it searches for signals named that way in any sub-module.
# I don't like they way AD did this.
