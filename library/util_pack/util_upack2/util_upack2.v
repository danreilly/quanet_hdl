...
module util_upack2 #(
  parameter NUM_OF_CHANNELS = 4,     // Dan: in daq3, this is 2
  parameter SAMPLES_PER_CHANNEL = 1, // Dan: in daq3  this is 4
  ...
  util_upack2_impl #(
    ...
    .s_axis_valid (s_axis_valid), // set to constant 1 by the BD (Dan)
