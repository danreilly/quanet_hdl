...
adi_ip_files axi_adcfifo [list \
  ...
  "$ad_hdl_dir/library/quanet/fifo_2clks_infer.xdc" \
...
# are made by scoping these xdc files to the modules:
...
set_property scoped_to_ref fifo_2clks_infer [get_files fifo_2clks_infer.xdc]
