#
# Dan: copied from zc706_plddr3_adcfifo_bd.tcl
#
#
...
proc ad_adcfifo_create {adc_fifo_name adc_data_width adc_dma_data_width adc_fifo_address_width} {
  ...
  # WILL NOT WORK. DataWIDTH IS READ ONLY>
  # This is set to 64.
  ...
  #  ad_ip_parameter axi_ddr_cntrl CONFIG.XML_INPUT_FILE zcu106_plddr4_mig.prj
  ...
  puts "will add adcfifo"
  ad_ip_instance axi_adcfifo $adc_fifo_name
  puts "done add adcfifo"
