...
XSA_FILE=system_top.xsa
UBOOT_FILE=u-boot_zynq_zc706.elf
...
(
cd $BUILD_DIR
echo NOT CALLING xsct create_fsbl_project.tcl
#  run xsct.bat create_fsbl_project.tcl
  echo '(dan) FSBL created!'
)
echo '(dan do we have)' $FSBL_PATH
