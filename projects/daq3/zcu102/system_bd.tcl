...
source $ad_hdl_dir/projects/common/zcu102/zcu102_plddr4_adcfifo_bd.tcl
...
# I disabled all these for the 106, and it worked.
# So I'll disable them again for the 102 - Dan.
...
# Dan changed this to be able to do dma to ddr4
# These things are already set in daq3_bd.tcl
