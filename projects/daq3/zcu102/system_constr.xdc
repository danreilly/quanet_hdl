...
set_property  -dict {PACKAGE_PIN  H14 IOSTANDARD LVCMOS18} [get_ports j3_6]
#set_property  -dict {PACKAGE_PIN  J14 IOSTANDARD LVCMOS18} [get_ports j3_8]
set_property  -dict {PACKAGE_PIN  G14 IOSTANDARD LVCMOS18} [get_ports j3_10]
set_property  -dict {PACKAGE_PIN  G15 IOSTANDARD LVCMOS18} [get_ports j3_12]
set_property  -dict {PACKAGE_PIN  J15 IOSTANDARD LVCMOS18} [get_ports j3_14]
set_property  -dict {PACKAGE_PIN  J16 IOSTANDARD LVCMOS18} [get_ports j3_16]
# set_property  -dict {PACKAGE_PIN  G16 IOSTANDARD LVCMOS18} [get_ports j3_18]
# set_property  -dict {PACKAGE_PIN  H16 IOSTANDARD LVCMOS18} [get_ports j3_20]
# set_property  -dict {PACKAGE_PIN  G13 IOSTANDARD LVCMOS18} [get_ports j3_22]
# set_property  -dict {PACKAGE_PIN  H13 IOSTANDARD LVCMOS18} [get_ports j3_24]


set_property  -dict {PACKAGE_PIN E4} [get_ports sfp0_tx_p]
set_property  -dict {PACKAGE_PIN E3} [get_ports sfp0_tx_n]
set_property  -dict {PACKAGE_PIN D2} [get_ports sfp0_rx_p]
set_property  -dict {PACKAGE_PIN D1} [get_ports sfp0_rx_n]
set_property  -dict {PACKAGE_PIN A12 IOSTANDARD LVCMOS33} [get_ports sfp0_tx_dis]

set_property PACKAGE_PIN B10 [get_ports si5328_out_c_p]
set_property PACKAGE_PIN B9  [get_ports si5328_out_c_n]

set_property  -dict {PACKAGE_PIN R10 IOSTANDARD LVDS} [get_ports rec_clock_p]
set_property  -dict {PACKAGE_PIN R9  IOSTANDARD LVDS} [get_ports rec_clock_n]
