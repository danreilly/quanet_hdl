...
### Create zynq.bif file used by bootgen to assemble BOOT.BIN
# DANs note: This script puts bootloader first.
# but the zynqmp.bif on the SD image has pmufw.elf first
