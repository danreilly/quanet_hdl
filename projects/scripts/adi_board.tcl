...
#  \param[p_clk]  - name of the clock or reset source
#  \param[p_name] - name or list of names of the clock or reset sink
#                   DAN: looking at daq3_bd.tcl, p_name seems to be a cellname/intfname
#
# dan:
# This seems to get called twice for every high perf interconnect.
# Once for PS to an AXI interconnect instance, and again for the intercon inst to another dma IP.
